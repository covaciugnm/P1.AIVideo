...
REQUIRED_ENDPOINTS: tuple[tuple[str, str], ...] = (
    ...
    # Phase 20 — per-voice sample audio for the TTS dropdown.
    ("GET", "/api/v1/providers/tts/{provider_id}/sample.wav"),
    # Generation
    ...
    ("POST", "/api/v1/characters/{character_id}/images/generate-initial"),
    ("POST", "/api/v1/characters/{character_id}/images/generate-consistent"),
    ("POST", "/api/v1/characters/{character_id}/images/upload-reference"),
    ("POST", "/api/v1/characters/{character_id}/images/{image_id}/moderate"),
    ...
    ("POST", "/api/v1/characters/{character_id}/images/{image_id}/set-full-body-reference"),
