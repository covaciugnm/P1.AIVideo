  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit}>
      ...
      <section className="card">
        ...
        {/* Phase 18 iter 2 — first 3 rows are INFORMATIONAL only.
            They mirror the live selection from sections 1 (LLM scenariu),
            2-Voice (LLM Text scenariu + TTS). Changing them here does
            nothing — the editable controls live in the sections above. */}
        <div className="field">
          <label title={t("createJob.scriptProviderHelp")}>
            {t("createJob.scriptProvider")}{" "}
            <small className="muted" style={{ fontWeight: 400 }}>
              ({t("createJob.providerInformational")})
            </small>
          </label>
          <input
            type="text"
            value={llmProvider ?? t("createJob.providerInherit")}
            readOnly
            style={{
              width: "100%", padding: "6px 10px",
              background: "rgba(255,255,255,0.04)", border: "1px solid var(--border)",
              borderRadius: 6, color: "var(--text)", fontFamily: "ui-monospace, monospace",
            }}
          />
        </div>
        <div className="field">
          <label title={t("createJob.textScriptProviderHelp")}>
            {t("createJob.textScriptProvider")}{" "}
            <small className="muted" style={{ fontWeight: 400 }}>
              ({t("createJob.providerInformational")})
            </small>
          ...
          <input
            type="text"
            value={textScriptLlmProvider ?? llmProvider ?? t("createJob.providerInherit")}
            readOnly
            style={{
              width: "100%", padding: "6px 10px",
              background: "rgba(255,255,255,0.04)", border: "1px solid var(--border)",
        ...
        <div className="field">
          <label title={t("createJob.ttsProviderHelp")}>
            {t("createJob.ttsProvider")}{" "}
            <small className="muted" style={{ fontWeight: 400 }}>
              ({t("createJob.providerInformational")})
            </small>
          ...
          <input
            type="text"
            value={ttsProvider ?? t("createJob.providerInherit")}
            readOnly
            style={{
              width: "100%", padding: "6px 10px",
              background: "rgba(255,255,255,0.04)", border: "1px solid var(--border)",
